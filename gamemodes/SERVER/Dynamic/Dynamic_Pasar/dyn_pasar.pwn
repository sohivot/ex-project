...
Pasar_Refresh(id)
{
    if(id != -1)
    {
        ...
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual Susu Olahan", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 2)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual Hasil Tambang", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 3)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual Kayu Kemas", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 4)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual Ayam Kemas", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 5)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual Hasil Daur", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 6)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual/membeli Hasil Tani", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 7)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual Pakaian", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 8)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual GAS", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
        else if(PasarData[id][pasarType] == 9)
        {
            PasarData[id][pasarLabel] = CreateDynamic3DTextLabel(sprintf(""LIGHTGREY"[PID: %d]\n"WHITE"Tekan"VERONA_GREEN" [ALT]"WHITE" untuk menjual Ikan Nelayan", id), -1, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2] + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0);
        }
    }
    return 1;
}
...
CMD:addpasar(playerid, params[])
{
    ...
    mysql_format(mdb_query, query, sizeof(query), "INSERT INTO pasar SET id=%d, posx='%f', posy='%f', posz='%f', type='%d', interior=%d, world=%d", id, PasarData[id][pasarPos][0], PasarData[id][pasarPos][1], PasarData[id][pasarPos][2], PasarData[id][pasarType], PasarData[id][pasarInt], PasarData[id][pasarWorld]);
	mysql_tquery(mdb_query, query, "OnPasarCreated", "ii", playerid, id);
	return 1;
}
...
CMD:removepasar(playerid, params[])
{
    ...
    mysql_tquery(mdb_query, sprintf("DELETE FROM pasar WHERE id='%d'", id));
    return 1;
}
