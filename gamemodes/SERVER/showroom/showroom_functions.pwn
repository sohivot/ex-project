...
hook OnScriptInit()
{
    ShowroomCheckpoint = CreateDynamicCP(397.698028, -1329.631958, 14.817037, 2.0, -1, 0, -1, 10.0);
    return 1;
}
...
hook OnPlayerEnterDynamicCP(playerid, STREAMER_TAG_CP:checkpointid)
{
    ...
    {
        ShowKey(playerid, "[ALT] Menu Showroom");
    }
    return 1;
}
...
TrukCost(playerid)
{
    ...
    if(TrukShowroom[SelectVeh[playerid]] == 499) return 32000;
    return -1;
}
...
VehicleTruckSelect(playerid)
{
    ...
    ShowroomVeh[playerid] = CreateVehicle(TrukShowroom[SelectVeh[playerid]], 378.8723, -1330.8447, 15.4398, 301.4344, random(255), random(255), 60000, 0);
...
VehicleSuvSelect(playerid)
{
    ...
    ShowroomVeh[playerid] = CreateVehicle(SuvShowroom[SelectVeh[playerid]], 378.8723, -1330.8447, 15.4398, 301.4344, random(255), random(255), 60000, 0);
    LinkVehicleToInterior(ShowroomVeh[playerid], GetPlayerInterior(playerid));
    SetVehicleVirtualWorld(ShowroomVeh[playerid], GetPlayerVirtualWorld(playerid));
    SetValidVehicleHealth(ShowroomVeh[playerid], 1000.0);
...
VehicleMotorSelect(playerid)
{
    ...
    ShowroomVeh[playerid] = CreateVehicle(MotorShowroom[SelectVeh[playerid]], 378.8723, -1330.8447, 15.4398, 301.4344, random(255), random(255), 60000, 0);
    LinkVehicleToInterior(ShowroomVeh[playerid], GetPlayerInterior(playerid));
    SetVehicleVirtualWorld(ShowroomVeh[playerid], GetPlayerVirtualWorld(playerid));
    SetValidVehicleHealth(ShowroomVeh[playerid], 1000.0);
...
VehicleLowriderSelect(playerid)
{
    ...
    ShowroomVeh[playerid] = CreateVehicle(ClassicShowroom[SelectVeh[playerid]], 378.8723, -1330.8447, 15.4398, 301.4344, random(255), random(255), 60000, 0);
    LinkVehicleToInterior(ShowroomVeh[playerid], GetPlayerInterior(playerid));
    SetVehicleVirtualWorld(ShowroomVeh[playerid], GetPlayerVirtualWorld(playerid));
    SetValidVehicleHealth(ShowroomVeh[playerid], 1000.0);
...
VehicleCompactSelect(playerid)
{
    ...
    ShowroomVeh[playerid] = CreateVehicle(CompactShowroom[SelectVeh[playerid]], 378.8723, -1330.8447, 15.4398, 301.4344, random(255), random(255), 60000, 0);
    LinkVehicleToInterior(ShowroomVeh[playerid], GetPlayerInterior(playerid));
    SetVehicleVirtualWorld(ShowroomVeh[playerid], GetPlayerVirtualWorld(playerid));
    SetValidVehicleHealth(ShowroomVeh[playerid], 1000.0);
...
VehicleLuxurySelect(playerid)
{
    ...
    ShowroomVeh[playerid] = CreateVehicle(LuxuryShowroom[SelectVeh[playerid]], 378.8723, -1330.8447, 15.4398, 301.4344, random(255), random(255), 60000, 0);
    LinkVehicleToInterior(ShowroomVeh[playerid], GetPlayerInterior(playerid));
    SetVehicleVirtualWorld(ShowroomVeh[playerid], GetPlayerVirtualWorld(playerid));
    SetValidVehicleHealth(ShowroomVeh[playerid], 1000.0);
        ...
        case DIALOG_SHOWROOM_SELL:
        {
            ...
            foreach(new i : PvtVehicles) if(PlayerVehicle[i][pVehExists])
            {
                if(strval(inputtext) == PlayerVehicle[i][pVehPhysic])
                {
                    ...
                    new query[255];
                    mysql_format(mdb_query, query, sizeof(query), "DELETE FROM `player_vehicles` WHERE `id`=%d", PlayerVehicle[i][pVehID]);
...
hook ClickDynPlayerTextdraw(playerid, PlayerText: playertextid)
{
    ...
    else if(playertextid == ATRP_ShowroomTD[playerid][13]) // Keluar Showroom
    {
        ...
        SetPlayerPositionEx(playerid, 397.698028, -1329.631958, 14.817037, 121.092803, 1500);
    ...
    else if(playertextid == ATRP_ShowroomTD[playerid][12]) // Buy
    {
        if(showroomID != 0)
        {
            if(showroomID == 1) // Truk
            {
                ...
                ShowroomVehicle_Create(playerid, modelid, 399.8399, -1319.8287, 15.2959, 211.4821, random(255), random(255), cost);
                static shstr[128];
...
ShowroomVehicle_Create(ownerid, modelid, Float:x, Float:y, Float:z, Float:angle, color1, color2, cost)
{
    ...
    if ((vehicleid = Iter_Free(PvtVehicles)) != cellmin)
    {
        ...
        SetPlayerPositionEx(ownerid, 399.8399, -1319.8287, 15.2959, 211.4821, 1000);
        ...
        mysql_tquery(mdb_query, "INSERT INTO `player_vehicles` (`PVeh_Faction`) VALUES('0')", "OnVehBuyCreated", "dd", ownerid, vehicleid);
        return vehicleid;
    }
    return -1;
}
...
/*ShowroomVehicle_Create(ownerid, modelid, Float:x, Float:y, Float:z, Float:angle, color1, color2, cost)
{
    ...
    new cQuery[1048];
    mysql_format(mdb_query, cQuery, sizeof(cQuery), "INSERT INTO `player_vehicles` (`PVeh_OwnerID`, `PVeh_ModelID`, `PVeh_Price`, `PVeh_Fuel`, `PVeh_Health`, `PVeh_Plate`, `PVeh_Parked`, `PVeh_Housed`, `PVeh_Families`, `PVeh_FactionGarage`, `PVeh_Rental`, `PVeh_RentTime`, \
    ...
    mysql_tquery(mdb_query, cQuery, "OnVehBuyCreated", "ii", ownerid, i);
    return 1;
}*/